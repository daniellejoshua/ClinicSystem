...
export default function TopBar({ isHidden }) {
  return (
    <div className={`${isHidden ? "hidden" : "block"}`}>
      <div className="min-h-[80px] w-full flex flex-col xl:flex-row gap-4 items-center Sp-4 xl:p-0">
        ...
        <div className="flex flex-wrap xl:flex-row xl:relative  gap-4 w-full justify-center xl:justify-evenly right-64 font-worksans font-medium">
